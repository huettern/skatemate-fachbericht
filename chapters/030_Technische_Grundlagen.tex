...
\subfigure[Sinstr][Messbrücke für FlexSensor]{ \includegraphics[width=0.5\linewidth]{images/FlexSensor_Messbruecke} \label{FlexSensor_Messbruecke}}
\caption[FlexSensor]{Funktionsprinzip und Ansteuerung für einen FlexSensor}
