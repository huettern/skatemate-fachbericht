...
In folgender Tabelle x werden die General Purpose Input Output (GPIO) Anforderungen an den Mikrocontroller aufgelistet.
\begin{center}
	\begin{tabular}{|c|c|c|c|}
		...
		\hline 
	\end{tabular} 
	\captionof{figure}{GPIO Anforderungen für den Mikrocontroller}
	\label{tabGPIObat}
\end{center}
