...
Die Programmfunktionalität des Magic Glove ist in verschiedene C-Module untergebracht. Eine Liste der implementierten Module ist in der Tabelle \ref{HW_MagicGlove} dargestellt.\\ \newline
