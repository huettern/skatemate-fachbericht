...
Schaltet der Motor aus, wenn der Benutzer nicht mehr auf dem Longboard steht? Wie gross ist die maximale Distanz, über die die Funkübertragung noch funktioniert?

\subsubsection*{Stromversorgung}
Funktioniert das aktive Balancing während dem Ladevorgang? Dazu werden die Zellspannungen während eines Ladevorganges überprüft und miteinander verglichen. Existiert der Überstromschutz?
\todo{gehört zur Stromvers-Valid! > gesamtvalid.frage??}

\subsubsection*{Motoransteuerung}
Ist das Fahren des Longboards ohne aktivierter Antrieb möglich?
